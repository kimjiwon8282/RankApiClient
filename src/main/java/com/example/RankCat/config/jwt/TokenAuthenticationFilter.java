...
public class TokenAuthenticationFilter extends OncePerRequestFilter {
    ...
    private static final String HEADER_AUTHORIZATION = "Authorization"; // Http 요청 헤더에 담기는 인증 토큰 키
    private static final String TOKEN_PREFIX = "Bearer "; // 헤더 값 앞에 붙는 접두사(Bearer)
    ...
    /**
     * 헤더 값에서 "Bearer " 접두사를 제거하고 순수한 JWT 토큰 문자열만 반환합니다.
     *
